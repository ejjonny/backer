            ...
            if highlight == HighlightedCase::AlignmentOffset || highlight == HighlightedCase::None {
                column_spaced(
                    ...
                    vec![
                        ...
                        stack(vec![
                            rect(BLUE),
                            rect(WHITE).height(30.).width(30.).align(XAlign::Leading),
                            rect(WHITE).height(30.).width(30.).align(XAlign::Trailing),
                            rect(WHITE).height(30.).width(30.).align(YAlign::Top),
                            rect(WHITE).height(30.).width(30.).align(YAlign::Bottom),
