use iced::{widget::Stack, Task};

pub fn main() -> iced::Result {
    iced::application("Iced Demo", Example::update, Example::view).run()
}
...
use iced_core::{Clipboard, Element, Layout, Length, Rectangle, Shell, Size, Vector, Widget};

#[allow(missing_debug_implementations)]
pub struct CustomLayout<'a, Message, Theme = iced::Theme, Renderer = iced::Renderer> {
    width: Length,
    height: Length,
    children: Vec<Element<'a, Message, Theme, Renderer>>,
}

impl<'a, Message, Theme, Renderer> CustomLayout<'a, Message, Theme, Renderer>
where
...
impl<'a, Message, Renderer> Default for CustomLayout<'a, Message, Renderer>
where
    Renderer: iced_core::Renderer,
{
    fn default() -> Self {
...
impl<'a, Message, Theme, Renderer> Widget<Message, Theme, Renderer>
    for CustomLayout<'a, Message, Theme, Renderer>
where
    Renderer: iced_core::Renderer,
{
...
impl<'a, Message, Theme, Renderer> From<CustomLayout<'a, Message, Theme, Renderer>>
...
{
    fn from(stack: CustomLayout<'a, Message, Theme, Renderer>) -> Self {
        Self::new(stack)
    }
}
